	...
	<div class="columns">
		<div class="column is-three-quarters">
			<div class="section content">
				...
				<h1 class="is-size-3 mb-medium">Course Title: {{$courses->name}}</h1>

				<h2 class="is-size-3">Course Description</h2>
				<p class="is-size-5">{!! nl2br($courses->description) !!}</p>

				<h2 class="is-size-3">Subject Combination for JAMB</h2>
				...
				<h2 class="is-size-3">Course Cut-of-Point</h2>
				...
				<h2 class="is-size-3">{{$courses->name}} Requirement UTME</h2>
				<div class="mb-medium">{{$courses->utme_requirements}}</div>

				<h2 class="is-size-3">{{$courses->name}} Requirements Direct Entry</h2>
				...
				<p>{!! nl2br($courses->considerations) !!}</p>

				<h2 class="is-size-3 mt-medium">Schools offering {{$courses->name}}</h2>
				<table class="table">
					<thead>
						<tr>
